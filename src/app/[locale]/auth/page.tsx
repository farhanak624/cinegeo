    ...
    <div className="flex min-h-screen items-center justify-center bg-bg-base px-4">
      ...
      >
        <div className="rounded-2xl border border-white/10 bg-bg-surface p-8 shadow-card">
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              <input type="email" value={email} onChange={(e) => setEmail(e.target.value)}
                placeholder={t("email")} className="input-cinema !pl-10" />
            </div>
            ...
            <div className="relative">
              ...
              <input type={showPassword ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)}
                placeholder={t("password")} className="input-cinema !pl-10 !pr-10" />
            ...
            {isSignUp && (
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-text-muted" />
                <input type="password" placeholder={t("confirmPassword")} className="input-cinema !pl-10" />
              </div>
            )}
          ...
          {/* Google OAuth */}
          <button className="flex w-full items-center justify-center gap-3 rounded-pill border border-white/10 bg-bg-elevated px-5 py-3 text-sm font-medium text-text-primary transition-all hover:bg-white/5">
          ...
          <p className="mt-6 text-center text-sm text-text-muted">
            ...
            <button onClick={() => setIsSignUp(!isSignUp)} className="text-accent-primary hover:text-accent-hover">
