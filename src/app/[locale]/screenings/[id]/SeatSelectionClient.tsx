...
import type { Seat, Screening } from "@/lib/types";
...
export default function SeatSelectionClient({ screening, initialSeats }: Props) {
              ...
              <div className="flex gap-4">
                <div className="relative h-24 w-16 flex-shrink-0 overflow-hidden rounded-md">
                  {movie.poster_url ? (
                    ...
                    <div className="flex h-full w-full items-center justify-center bg-bg-elevated text-xs text-text-muted">N/A</div>
                  )}
                </div>
                <div>
